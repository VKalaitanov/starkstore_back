# Generated by Django 4.2.16 on 2024-11-30 14:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_unit', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='USD', max_digits=15, verbose_name='Цена')),
                ('discount_percentage', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='Скидка (%)')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('points', models.ManyToManyField(related_name='service_option', to='services.pointsserviceoption', verbose_name='Пункты для опции')),
                ('required_field', models.ManyToManyField(related_name='service_option', to='services.requiredfield', verbose_name='Динамические поля')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='services.service', verbose_name='Название сервиса')),
            ],
            options={
